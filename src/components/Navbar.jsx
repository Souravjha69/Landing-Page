...
function Navbar() {
    ...
    return (
        <nav className="border-b-2">
            <div className="max-w-7-xl mx-auto flex justify-between items-center py-8">
                <div className="pl-2">
                    <a href="#">
                        <img src={logo} height={19} width={150} alt="VastuSpazeLogo"/>
                    </a>
                </div>
                <div className="md:hidden">
                    <button onClick={toggleMenu} className="text-2xl pr-2 focus:ouline-none" aria-label={isOpen? "Close menu": "Open menu"}>
